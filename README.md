...
Her `BASLA.md dosyasını oku` veya normal `devam` komutunda gerçek `main`, açık PR/CI ve checkpoint doğrulanır. AŞAMA 16 tamamlandığından sonraki normal çalışma AŞAMA 17'dir (Büyük Dosya Streaming & Performans / Mekansal İndeksleme / LOD). Runner çevrim dışıysa kanıtsız PASS yazılmaz ve aynı test işi çoğaltılmaz.
