...
Her `BASLA.md dosyasını oku` veya normal `devam` komutunda gerçek `main`, açık PR/CI ve checkpoint doğrulanır. AŞAMA 12 tamamlandığından sonraki normal çalışma AŞAMA 13'tür (Layer, Color, Linetype, Lineweight). Runner çevrim dışıysa kanıtsız PASS yazılmaz ve aynı test işi çoğaltılmaz.
