...
Her `BASLA.md dosyasını oku` veya normal `devam` komutunda gerçek `main`, açık PR/CI ve checkpoint doğrulanır. AŞAMA 11 tamamlandığından sonraki normal çalışma AŞAMA 12'dir (DWG R13–R2018 Parser Çekirdeği). Runner çevrim dışıysa kanıtsız PASS yazılmaz ve aynı test işi çoğaltılmaz.
