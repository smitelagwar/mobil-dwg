...
public static class NativeSmokeRunner
{
    ...
    public static void TestNativePanSmoke()
    {
    ...
    public static void TestNativePinchSmoke()
    {
        var camera = new Camera2D(1080, 2400, new WorldPoint2(0, 0), 1.0);
        var controller = new ViewportController(camera);
        var engine = new ViewportInteractionEngine(controller);
    ...
    public static void TestNativeOneTwoOneSmoke()
    {
        var camera = new Camera2D(1080, 2400, new WorldPoint2(0, 0), 1.0);
        var controller = new ViewportController(camera);
        var engine = new ViewportInteractionEngine(controller);
    ...
    public static void TestNativeCancelSmoke()
    {
        var camera = new Camera2D(1080, 2400, new WorldPoint2(0, 0), 1.0);
        var controller = new ViewportController(camera);
        var engine = new ViewportInteractionEngine(controller);
    ...
    public static void TestNativeSentinelBeforeUpSmoke()
    {
        var camera = new Camera2D(1080, 2400, new WorldPoint2(0, 0), 1.0);
        var controller = new ViewportController(camera);
        var engine = new ViewportInteractionEngine(controller);
    ...
    public static void TestNativeResizeSmoke()
    {
    ...
    public static void TestNativeCorpusTouchAndFrameBudgets()
    {
